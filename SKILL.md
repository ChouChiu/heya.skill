...
9. **最常用公式**：`{事件们} | AI日报{日期}`（55次）
10. **交叉风格**：「情感式」含交叉匹配 81 次（86.2%），标题常兼具多种风格
...
**高频词 Top 20**：
AI日报(55)、模型(32)、DeepSeek(29)、AI(19)、Gemini(15)、OpenAI(14)、引爆(10)、AI圈(10)、硅谷(8)、泄露(8)、深夜(7)、来袭(7)、AI圈大地震(7)、V4(7)、Claude(7)、Anthropic(6)、Kimi(6)、Agent(6)、彻底(6)、杀疯了(6)
...
**名词/实体词（主题概念）**：
AI日报(55)、模型(32)、AI圈(10)、硅谷(8)、深夜(7)、AI圈大地震(7)、奥特曼(6)、人类(6)、马斯克(5)、头皮发麻(5)

**英文词（品牌/产品名）**：
DeepSeek(29)、AI(19)、Gemini(15)、OpenAI(14)、V4(7)、Claude(7)、Anthropic(6)、Kimi(6)、Agent(6)、Google(6)

**公司/机构**：
DeepSeek(28)、OpenAI(13)、Google(10)、Anthropic(6)、腾讯(5)、智谱(4)、MiniMax(4)、字节跳动(1)、xAI(1)、月之暗面(1)

**产品/模型**：
Gemini(14)、Claude(7)、Kimi(6)、GPT(5)、Qwen(4)、Opus(3)、Mythos(3)、Grok(3)、千问(3)、混元(2)
...
- 标题变长：从 2026-02 的 42.3 字 → 2026-05 的 58.2 字
- 情绪升级：强度从 2 → 6.9
- 最新高频情绪词：后背发凉
